...
namespace CAS.CommServer.ProtocolHub.Scripts
{
  ...
  public class CreateTagPrototyping
  {
    ...
    public void CreateTagTest()
    {
      ...
      string _solutionPath = @"/CommServer.ProtocolHub";
      string _trunkPath = $@"{_repositoryUrl}trunk{_solutionPath}/";
      string _tagPath = $@"{_repositoryUrl}tags{_solutionPath}.rel_{_rel}";
      #endregion

      Assert.AreEqual("svn://svnserver.hq.cas.com.pl/VS/trunk/CommServer.ProtocolHub/", _trunkPath);
      Assert.AreEqual("svn://svnserver.hq.cas.com.pl/VS/tags/CommServer.ProtocolHub.rel_2_01_1061", _tagPath);
