...
namespace CAS.CommServer.ProtocolHub.Communication.BaseStation
{
  ...
  internal class SegmentStateMachine : WaitTimeList<SegmentStateMachine>.TODescriptor
  {
    ...
    private static string GetAt => ", At = " + myStopwatch.Elapsed.ToString();
    ...
    private abstract class ReadWriteOperations : SegmentState
    {
      ...
      {
        switch (myMachine.myProtocol.ReadData(dataAddress, pipeInterface.address, out IReadValue value, pipeInterface.Retries.Retry))
        {
    ...
    {
      #region private
      private readonly IAddress myAddress;
      private TimeSpan myTimeReconnect;
    ...
    private sealed class DisconnectedSegmentState : ConnectRequestOperation
    {
      ...
      #endregion
      #region public
      public override State CurrentState => State.Disconnected;
      #endregion
      #region constructors
    ...
    private sealed class KeepConnectionSegmentState : ReadWriteOperations
    {
      ...
      #endregion
      #region public
      public override State CurrentState => State.KeepConnection;
    ...
    private sealed class ConnectedSegmentState : ReadWriteOperations
    {
      ...
      #region public
      public override State CurrentState => State.Connected;
      public override void DisconnectRequest()
      {
    ...
    private sealed class DisconnectedAfterFailureSegmentState : ConnectRequestOperation
    {
      ...
      #region public
      public override State CurrentState => State.DisconnectedAfterFailure;
      #endregion
    ...
    public State CurrentState => myCurrentSegmentState.CurrentState;
    /// <summary>
    /// Connect request.
    /// </summary>
    ...
    public bool NeedsChannelAccess => myNumberOfInProgressReaWriteOperations > 0;
    /// <summary>
