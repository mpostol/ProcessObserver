...
CategoryAttribute("XXX debug"),
 ...
 DefaultValueAttribute(0),
    ...
    public long StationID => (m_Parent.StationID);
...
DescriptionAttribute("Unique group numerical identifier")
    ...
    public long GroupID => (m_Parent.GroupID);
    ...
    {
      get => (m_Parent.TimeScanFast);
      set => m_Parent.TimeScanFast = value;
    }
    ...
    {
      get => (m_Parent.TimeOutFast);
      set => m_Parent.TimeOutFast = value;
    }
