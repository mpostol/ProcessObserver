...
CategoryAttribute("XXX debug"),
 ...
 DefaultValueAttribute(0),
    ...
    public long StationID => (m_Parent.TagsRow.DataBlocksRow.GroupsRow.StationID);
...
CategoryAttribute("XXX debug"),
 ...
 DefaultValueAttribute(0),
    ...
    public string StationName => (m_Parent.TagsRow.DataBlocksRow.GroupsRow.StationRow.Name);
...
CategoryAttribute("XXX debug"),
 ...
 DefaultValueAttribute(0),
    ...
    public long TagID => (m_Parent.TagID);
...
CategoryAttribute("XXX debug"),
 ...
 DefaultValueAttribute(0),
    ...
    public string TagName => (m_Parent.TagsRow.Name);
...
CategoryAttribute("XXX debug"),
 ...
 DefaultValueAttribute(0),
    ...
    public ulong Address => (m_Parent.TagsRow.DataBlocksRow.Address);
    ...
    {
      get => (m_Parent.BitNumber);
      set => m_Parent.BitNumber = value;
    }
