...
DisplayNameAttribute("Station name")
    ...
    public string StationName => (m_Parent.GroupsRow.StationRow.Name);
...
CategoryAttribute("XXX debug"),
 ...
 DefaultValueAttribute(0),
  DescriptionAttribute(
    ...
    public long StationId => (m_Parent.GroupsRow.StationID);
    ...
    public long AddressStart => AddressSpaceDescriptor.StartAddress;
    ...
    public long AddressEnd => AddressSpaceDescriptor.EndAddress;
...
"Identifier of the coupled group (to make the configuration easier, NetworkConfig displays name of the coupled group instead of its numerical identifier). The datablock can belong only to one group."
    ...
    public string GroupName => (m_Parent.GroupsRow.Name);
...
CategoryAttribute("XXX debug"),
 ...
 DefaultValueAttribute(0),
  DescriptionAttribute(
    ...
    public string GroupId => (m_Parent.GroupsRow.Name);
    ...
    {
      get => WrappersHelpers.GetName(GetAvailiableAddressSpaces(), Convert.ToInt16(m_Parent.DataType));
